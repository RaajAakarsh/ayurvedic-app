...
const yogaPositions = [
  {
    ...
    image: downwardDog,
    description: "Balances Vata by grounding energy, enhances circulation, and revitalizes Prana throughout the body."
  },
  {
    id: 2,
    name: "Vrikshasana (Tree Pose)",
    image: treePose,
    description: "Cultivates inner stillness and focus, strengthens the core, and aligns the body's energies, harmonizing Vata and Pitta."
  },
  {
    id: 3,
    name: "Virabhadrasana II (Warrior II)",
    image: warriorII,
    description: "Ignites inner fire (Agni), strengthens the lower body, and opens the chest, balancing Kapha and Pitta doshas."
  },
  {
    id: 4,
    name: "Setu Bandhasana (Bridge Pose)",
    image: bridgePose,
    description: "Invokes heart-opening energy, stimulates digestion, and nourishes the nervous system, balancing Kapha and Vata."
  },
  {
    id: 5,
    name: "Balasana (Child’s Pose)",
    image: childPose,
    description: "Deeply calming for the mind, soothes the nervous system, and releases tension, bringing balance to Vata dosha."
  },
];
          ...
          <div className="news-slider__arrows">
            <button className="news-slider__arrow news-slider-prev">
              <span className="icon-font">
                <svg className="icon icon-arrow-left"><use xlinkHref="#icon-arrow-left">
            ...
            <button className="news-slider__arrow news-slider-next">
              <span className="icon-font">
                <svg className="icon icon-arrow-right"><use xlinkHref="#icon-arrow-right"><symbol id="icon-arrow-right" viewBox="0 0 32 32">
